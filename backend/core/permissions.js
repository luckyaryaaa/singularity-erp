...
const ROLE_GRANTS = {
  ...
  finance_manager: expand(['dashboard','approval','notification','customer','invoice','payment','payment_proposal','supplier_invoice','supplier_payment','expense','asset','budget','report','job','approval_policy','credit'], ACTIONS)
  ...
  sales: expand(['dashboard','approval','notification','customer','inquiry','quotation','customer_po','sales_order','project','rma','report','job'], ACTIONS)
