...
const ROUTE_MATRIX = Object.freeze([
  { file:'auth.js', handlers:18, directGuards:0, delegated:0, public:18, strategy:'PUBLIC_OR_SESSION_SELF_SERVICE_MFA_RECOVERY', evidence:['test/api.test.js','test/postgres-auth.integration.test.js','test/postgres.http.test.js'] },
