...
const ROUTE_MATRIX = Object.freeze([
  { file:'auth.js', handlers:24, directGuards:0, delegated:0, public:24, strategy:'PUBLIC_OR_SESSION_SELF_SERVICE_MFA_RECOVERY_AND_WEBAUTHN', evidence:['test/api.test.js','test/postgres-auth.integration.test.js','test/postgres.http.test.js'] },
  ...
  { file:'masters.js', handlers:48, directGuards:30, delegated:18, public:0, strategy:'DYNAMIC_MASTER_PERMISSION_RLS_STAGING_MAKER_CHECKER_AND_PRIVATE_PROFILE_MEDIA', evidence:['test/postgres.integration.test.js','test/sprint8c-master-governance.test.js','test/sprint8c-wave2.test.js','test/wave3-business-partner-mdm.test.js'] },
