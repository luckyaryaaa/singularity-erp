...
const ROUTE_MATRIX = Object.freeze([
  ...
  { file:'masters.js', handlers:34, directGuards:17, strategy:'DYNAMIC_MASTER_PERMISSION_AND_REPOSITORY_SCOPE', evidence:['test/sprint8c-master-governance.test.js','test/sprint8c-wave2.test.js'] },
  { file:'organization.js', handlers:14, directGuards:4, strategy:'REPOSITORY_SCOPE_OWNER_PIN_AND_MFA', evidence:['test/sprint7-organization-employee.test.js','test/sprint15-docs.test.js'] },
