...
const ROUTE_MATRIX = Object.freeze([
  ...
  { file:'finance.js', handlers:30, directGuards:30, delegated:0, public:0, strategy:'PERMISSION_BRANCH_PIN_AND_SOD', evidence:['test/sprint13-finance.test.js','test/branch-isolation.test.js'] },
