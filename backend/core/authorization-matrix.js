...
const ROUTE_MATRIX = Object.freeze([
  ...
  { file:'inventory.js', handlers:30, directGuards:8, delegated:22, public:0, strategy:'PERMISSION_RLS_CANONICAL_WAREHOUSE_MOBILITY_VERSION_AND_IDEMPOTENCY', evidence:['test/sprint11-inventory-lots.test.js','test/wave6-stock-reservations.test.js','test/wave12-execution-hardening.test.js','test/wave18-warehouse-tasks.test.js','test/wave19-canonical-warehouse.test.js','test/wave24-warehouse-mobility.test.js'] },
