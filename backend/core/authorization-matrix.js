...
const ROUTE_MATRIX = Object.freeze([
  ...
  { file:'masters.js', handlers:49, directGuards:30, delegated:19, public:0, strategy:'DYNAMIC_MASTER_PERMISSION_RLS_STAGING_MAKER_CHECKER_AND_PRIVATE_PROFILE_MEDIA', evidence:['test/postgres.integration.test.js','test/sprint8c-master-governance.test.js','test/sprint8c-wave2.test.js','test/wave3-business-partner-mdm.test.js'] },
