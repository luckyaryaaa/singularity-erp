...
const ENDPOINTS = [
  ...
  ['GET', '/api/work-items', 'Workspace', 'Papan kerja Work Item + ringkasan (SLA/overdue)'],
  ['POST', '/api/work-items', 'Workspace', 'Buat work item bertipe (idempotency)'],
  ['POST', '/api/work-items/{id}/claim', 'Workspace', 'Klaim work item (version)'],
  ['POST', '/api/work-items/{id}/complete', 'Workspace', 'Selesaikan work item + evidence (version + idempotency)'],
  ['POST', '/api/work-items/{id}/delegate', 'Workspace', 'Delegasikan work item (substitusi/cuti, version)'],
  ['POST', '/api/work-items/{id}/escalate', 'Workspace', 'Eskalasi work item (version)'],
  ...
  ['GET', '/api/inventory/reconciliation', 'Inventory', 'Rekonsiliasi read-switch (dimensi + saldo) + grain aktif'],
  ['GET', '/api/inventory/stock-by-warehouse', 'Inventory', 'Stok pada grain gudang kanonik'],
  ['POST', '/api/inventory/read-grain', 'Inventory', 'Aktifkan/rollback read-grain BRANCH↔CANONICAL (gate rekonsiliasi, settings.edit)'],
