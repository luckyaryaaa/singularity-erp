...
Baseline v0.49.0 mencakup 14 bounded router dan 333 handler HTTP.
...
|---|---:|---|---|
| Auth | 24 | public allowlist atau own authenticated session | login, lockout, MFA, recovery code sekali pakai, session expiry, edit profil & foto sendiri, passkey/WebAuthn (register & login) |
